...
RE_ATTR = re.compile(rf"(?P<attr_name>{IDENTIFIER}){ATTR}", flags=re.I | re.X)
...
class HTML(Block):
    ...
    NAME = "html"
    ARGUMENT = True
    OPTIONS = {"markdown": ("auto", type_string_in(VALID_MODES))}
...
class HTMLExtension(BlocksExtension):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.config = {"custom": [[], "Specify handling for custom blocks."]}
