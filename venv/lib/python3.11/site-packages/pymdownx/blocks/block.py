...
def _string_in(
    value: Any, accepted: Iterable[str], string_type: Callable[[Any], str]
) -> str:
...
def type_string_in(
    accepted: Iterable[str], insensitive: bool = True
) -> Callable[[Any], str]:
...
def type_string_delimiter(
    split: str, string_type: Callable[[Any], str] = type_string
...
class Block(metaclass=ABCMeta):
    ...
    def __init__(
        self, length: int, tracker: Any, block_mgr: BlocksProcessor, config: Any
    ):
        """
        Initialize.
