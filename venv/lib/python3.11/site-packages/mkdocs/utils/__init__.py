...
def modified_time(file_path):
    warnings.warn(
        "modified_time is never used in MkDocs and will be removed soon.",
        DeprecationWarning,
    )
...
def get_html_path(path):
    warnings.warn(
        "get_html_path is never used in MkDocs and will be removed soon.",
        DeprecationWarning,
    )
...
def get_url_path(path, use_directory_urls=True):
    warnings.warn(
        "get_url_path is never used in MkDocs and will be removed soon.",
        DeprecationWarning,
    )
...
def is_html_file(path):
    warnings.warn(
        "is_html_file is never used in MkDocs and will be removed soon.",
        DeprecationWarning,
    )
...
def is_template_file(path):
    warnings.warn(
        "is_template_file is never used in MkDocs and will be removed soon.",
        DeprecationWarning,
    )
